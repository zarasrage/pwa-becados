...
import { getRecoloredFrames, baseSrc, accSrc, accLayers, SEXO_DEFAULT } from "./recolorSprites.js";
...
export function FloorAvatar({ av, isSel, sz, i, onSelect, look }) {
  ...
  return (
    <div style={{ position:"relative", width:sz, height:sz, flexShrink:0 }}>
      ...
      {accLayers(look).map((k) => (
        <img key={k} src={accSrc(k, frame)} alt="" width={sz} height={sz}
