...
// ── CSS global ────────────────────────────────────────────────────────────────
const CSS = `@import url('https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400;12..96,500;12..96,600;12..96,700;12..96,800&family=Inter:wght@300;400;500;600&family=JetBrains+Mono:wght@400;500&display=swap'); *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; } html { -webkit-text-size-adjust: 100%; } @keyframes fadeUp   { from{opacity:0;transform:translateY(10px)} to{opacity:1;transform:none} } @keyframes fadeIn   { from{opacity:0} to{opacity:1} } @keyframes spin     { to{transform:rotate(360deg)} } @keyframes slideDown { from{opacity:0;transform:translateY(-8px)} to{opacity:1;transform:none} } .anim  { animation: fadeUp 0.28s ease both; } .fade  { animation: fadeIn 0.2s ease both; } .press { transition: transform 0.1s, opacity 0.1s; -webkit-tap-highlight-color: transparent; cursor: pointer; } .press:active { transform: scale(0.96); opacity: 0.82; } ::-webkit-scrollbar { width: 0; }`;
...
const handleShowRotaciones = () => { setBecado(”**rotaciones**”); };
...
return (
<div style={{minHeight:“100vh”,background:T.bg,maxWidth:480,margin:“0 auto”,fontFamily:”‘Inter’,sans-serif”,paddingBottom: becado&&becado!==”**rotaciones**” ? 72 : 0, position:“relative”,overflow:“hidden”}}>
<style>{CSS}</style>
