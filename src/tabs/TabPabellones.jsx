...
export const EQUIPOS = [
  ...
  { id: 4, nombre: "Rodilla",       color: "#EAB308", cirujanos: ["BUSTOS FELIPE IGNACIO","CASTRO NICOLAS CRISTIAN","DIAZ RODRIGO","FRANULIC NICOLAS ALEJANDRO","GAGGERO NICOLAS SANTIAGO","GUARDA HECTOR","GUARDA TOMAS","INNOCENTI PIERO ANTONIO","KOCH MARCO ANTONIO","LASO JOSE IGNACIO","MUNOZ JOSE TOMAS","OLIVIERI RODRIGO ALEJANDRO","PINEDA TOMAS","PIZARRO MATIAS","ROJAS CARLOS","UGARTE JAIME","VALIENTE DIEGO ALBERTO JESUS","VILLABLANCA VICTOR"] },
